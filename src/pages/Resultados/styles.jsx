...
export const CamposResultado = styled.div`
  background: #f3f3f3;
  width: 50%;
  border-radius: 5px;
  padding: 10px 15px;
  ...
  &:hover {
    ...
    /* background: #35A9A1; */
    background: #43cea2;  /* fallback for old browsers */
    background: -webkit-linear-gradient(to right, #309AA0, #35aebc);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #309AA0, #35aebc); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    cursor: pointer;
  }
`;